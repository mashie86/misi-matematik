const CACHE='misi-matematik-v5';
const ASSETS=['./','./index.html','./style.css','./app.js','./bank.js','./easy.js','./effects.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
