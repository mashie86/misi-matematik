const CACHE='misi-matematik-v7';
const ASSETS=['./','./index.html','./style.css','./app.js','./bank.js','./easy.js','./effects.js','./correct.wav','./wrong.wav','./finish.wav','./tap.wav','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
